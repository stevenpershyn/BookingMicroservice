...
public class Booking {
	...
	private Date checkInDate;  // TODO: Change the datatype
	private Date checkOutDate;	// TODO: Change the datatype
	private Date bookedOnDate;	// TODO: Change the datatype
	...
	public Booking(int bookingId, int hotelId, int hotelRoomId, int noRooms, Set<Guest> guests, Date checkInDate,
			Date checkOutDate, Date bookedOnDate, String status, float price, float discount, String customerMobile,
